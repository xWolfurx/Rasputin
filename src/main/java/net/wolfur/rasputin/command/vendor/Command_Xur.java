...
public class Command_Xur implements Command {
    ...
    private EmbedBuilder createEmbedBuilder(BungieUser targetUser, XurInformation xurInformation, String location) {
        ...
        description.append("\n");
        description.append("**Legendary Shards:** " + this.formatInteger(legendaryShards) + " " + Utils.getEmote(Main.getFileManager().getEmoteDefinitionFile().getMaterial(String.valueOf(CurrenciesType.LEGENDARY_SHARDS.getItemHash()))).getAsMention());
        description.append("\n");
        description.append("\n");
