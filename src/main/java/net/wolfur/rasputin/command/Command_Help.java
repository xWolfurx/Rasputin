...
public class Command_Help implements Command {
    ...
    private EmbedBuilder getEmbedBuilder(String type, Member member) {
        ...
        if(type.equalsIgnoreCase("general")) {
            ...
            sb.append(this.commandWithPermission("register", member, " - .Register » Verknüpfe dich mit Rasputin")).append("\n");
            sb.append("**Vendors:**").append("\n");
            sb.append(this.commandWithPermission("spider", member, " - .Spider » Informationen über die Angebote von Spider.")).append("\n");
            sb.append(this.commandWithPermission("xur", member, " - .Xur » Informationen über die Angebote von Xûr.")).append("\n");
            sb.append(this.commandWithPermission("gunsmith", member, " - .Gunsmith » Informationen über die Angebote von Banshee-44.")).append("\n");
            sb.append("**Statistics:**").append("\n");
            sb.append(this.commandWithPermission("dsc", member, " - .DSC [@Spieler] » Statistiken vom Deep Stone Crypt Raid.")).append("\n");
            sb.append(this.commandWithPermission("gos", member, " - .GoS [@Spieler] » Statistiken vom Garden of Salvation Raid")).append("\n");
            sb.append(this.commandWithPermission("lw", member, " - .LW [@Spieler] » Statistiken vom Last Wish Raid")).append("\n");
            sb.append(this.commandWithPermission("pit", member," - .Pit [@Spieler] » Statistiken von der Grube der Ketzerei.")).append("\n");
            sb.append(this.commandWithPermission("prophecy", member, " - .Prophecy [@Spieler] » Statistiken vom Dungeon 'Prophezeiung'.")).append("\n");
            sb.append(this.commandWithPermission("throne", member, " - .Throne [@Spieler] » Statistiken vom Zerbrochenen Thron.")).append("\n");
            sb.append(this.commandWithPermission("trials", member, " - .Trials [@Spieler] » Statistiken von Trials of Osiris")).append("\n");
            sb.append(this.commandWithPermission("ranking", member, " - .Ranking <Type> » Clan-Internes Ranking.")).append("\n");
            sb.append(this.commandWithPermission("characters", member, " - .Characters [@Spieler] » Informationen über die Charaktere")).append("\n");
            sb.append("**Activities:**").append("\n");
            sb.append(this.commandWithPermission("fireteam", member," - .Fireteam [@Spieler] » Zeigt den aktuellen Einsatztrupp an.")).append("\n");
            sb.append(this.commandWithPermission("current", member, " - .Current [@Spieler] » Zeigt die aktuelle Aktivität an.")).append("\n");
            sb.append(this.commandWithPermission("online", member, " - .Online » Zeigt alle aktiven Clan-Spieler an.")).append("\n");
            sb.append(this.commandWithPermission("last", member, " - .Last <Activity> [@Spieler] » Statistiken der letzten Aktivität.")).append("\n");
            ...
            sb.append(this.commandWithPermission("loadout", member, " - .Loadout [@Spieler] » Ausrüstung des zuletzt gespielten Charakter.")).append("\n");
            sb.append("**Clan:**").append("\n");
            sb.append(this.commandWithPermission("clan", member, " - .Clan » Statistiken über den aktuellen Clan.")).append("\n");
